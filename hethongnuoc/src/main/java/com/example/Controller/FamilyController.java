...
import com.example.Mapper.DataMapping;
...
public class FamilyController {
	...
	DataMapping familyMapping = new DataMapping();
	...
	public HttpStatus modifiLogin(@PathVariable String id, @RequestBody Family family) {
		...
		try {
			...
			} else if (family.getHinhThucTT() == null) {
				family.setHinhThucTT(f.getHinhThucTT());
			} else {
				family.setNameFamily(family.getNameFamily());
				family.setDatePayment(family.getDatePayment());
				family.setHinhThucTT(family.getHinhThucTT());
			}
